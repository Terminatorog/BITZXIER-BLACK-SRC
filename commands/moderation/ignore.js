                    ...
                    .then(async (data) => {
                        ...
                        if (!data) {
                            ...
                            const saiop = client.util.embed()
                                .setColor(client.color)
                                .setDescription(
                                    `Great news! Your server is now configured perfectly. Feel free to use ignore module and enjoy using your server hassle-free! <a:rockets:1376304217278648530>`
                                )
